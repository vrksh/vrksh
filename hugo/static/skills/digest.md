...
When to use: hash data for integrity checks, cache keys, or HMAC authentication.
...
Anti-pattern:
- Don't use `echo` when you need exact byte hashing -- echo appends a newline. Use `printf` or positional arg instead.
